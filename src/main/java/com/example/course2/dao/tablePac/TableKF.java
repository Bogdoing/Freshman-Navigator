...
/**
 * Класс создающий таблицу типа (кафедра)
 */
public class TableKF implements TableDAO{

    /**
     * Создание тиблицы типа (кафедра)
     * @param TVfac
     */
    @Override
    public void getTable(TableView TVfac) {

        TableColumn Col0 = new TableColumn("name_k");
        Col0.setMinWidth(100);
        Col0.setCellValueFactory(new PropertyValueFactory<Fac, String>("name_k"));
        ...
        TableColumn Col4 = new TableColumn("name_f");
        Col4.setMinWidth(100);
        Col4.setCellValueFactory(new PropertyValueFactory<Fac, Integer>("name_f"));

        TVfac.getColumns().clear();
        TVfac.getColumns().addAll(Col0, Col1, Col2, Col3, Col4); //, Col1, Col3, Col4
